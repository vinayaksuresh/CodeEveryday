...
INSERT INTO Department (DeptId, DeptName) VALUES (3, 'Research');


INSERT INTO Project (ProjId, ProjName) VALUES (1, 'Apollo');
INSERT INTO Project (ProjId, ProjName) VALUES (2, 'Plutonium');
INSERT INTO Project (ProjId, ProjName) VALUES (3, 'Fusion');


INSERT INTO Task (TaskId, TaskName, ProjId) VALUES (1, 'Design', 2);
INSERT INTO Task (TaskId, TaskName, ProjId) VALUES (2, 'Analysis', 1);
INSERT INTO Task (TaskId, TaskName, ProjId) VALUES (3, 'Audit', 3);

INSERT INTO Employee (EmpId, EmpName, EmpRole, HomeZipCode, DeptId, ManagerId) VALUES (1, 'John', 'Director', 90033, 1, null);
INSERT INTO Employee (EmpId, EmpName, EmpRole, HomeZipCode, DeptId, ManagerId) VALUES (2, 'Allie', 'Analyst', 67136, 2, null);
INSERT INTO Employee (EmpId, EmpName, EmpRole, HomeZipCode, DeptId, ManagerId) VALUES (3, 'Anne', 'Developer', 78723, 1, 1);

INSERT INTO TaskEmployees (TaskId, EmpId) VALUES (1, 2);
INSERT INTO TaskEmployees (TaskId, EmpId) VALUES (2, 2);
INSERT INTO TaskEmployees (TaskId, EmpId) VALUES (3, 3);


INSERT INTO ProjectLeader (ProjId, LeaderId, StartDate, EndDate) VALUES (1, 1, DATE('2019-1-21'), DATE('2019-08-01'));
INSERT INTO ProjectLeader (ProjId, LeaderId, StartDate) VALUES (2, 2, DATE('2019-09-21'));
...
WHERE ManagerId IN (SELECT LeaderId FROM ProjectLeader WHERE StartDate > 1999-12-31);


-- 1.11. Find the names of all employees who are managed by a manager who lives in the same zip code as them.
SELECT e.EmpName FROM Employee as e, Employee as m
